...
const correctionQuestions: Question[] = [
  {
    id: "1B",
    text: "Has the individual requested that you correct, destroy, or delete their personal information because it is inaccurate, irrelevant, excessive, outdated, incomplete, misleading, unlawfully obtained, or because you are no longer required to retain it?",
  ...
  {
    id: "2B",
    text: "Is the information indeed inaccurate, irrelevant, excessive, outdated, incomplete, misleading, unlawfully obtained, or are you no longer required to retain it?",
